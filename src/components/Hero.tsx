  ...
  return (
    <div className="bg-montys-green text-white py-12 text-center">
      <div className="container mx-auto px-4">
        <h1 className="text-4xl md:text-5xl font-bold mb-8">Monty's Meals</h1>
        <div className="max-w-3xl mx-auto">
          <p className="text-xl md:text-2xl mb-8">
            Monty's Larder food for dogs has been vet developed to provide your dog with a complete and balanced diet.
          </p>
